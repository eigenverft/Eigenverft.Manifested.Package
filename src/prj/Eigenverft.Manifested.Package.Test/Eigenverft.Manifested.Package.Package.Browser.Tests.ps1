...
Invoke-TestPackageDescribe -Name 'Eigenverft.Manifested.Package Package - browser and packaged documentation' -Body {
    It 'ships a standalone offline documentation index with explicit custom and library assets' {
        ...
        $packageDepotMaterializeContent | Should -Match 'Invoke-PackageDepotMaterialize -WhatIf'
        $packageDepotMaterializeContent | Should -Match 'does not prompt for confirmation'
        $packageDepotMaterializeContent | Should -Match '-AcceptUnknownSigningKey'
        ...
        $offlineBootstrapContent | Should -Match 'Invoke-PackageDepotMaterialize'
