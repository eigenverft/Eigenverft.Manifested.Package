<#
    Eigenverft.Manifested.Package.Package.LocalEnvironment
#>
...
#>
    ...
    Add-PackageLocalEnvironmentDirectoryCandidate -Candidates $directoryCandidates -Path (Split-Path -Parent (Get-PackageLocalTrustInventoryPath))
    ...
    Add-PackageLocalEnvironmentDirectoryCandidate -Candidates $directoryCandidates -Path ([string]$PackageConfig.LocalEndpointRoot)
