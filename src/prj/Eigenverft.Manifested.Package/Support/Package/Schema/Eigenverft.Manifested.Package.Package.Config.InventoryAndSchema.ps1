<#
    Eigenverft.Manifested.Package.Package.Config - depot inventory and global config schema assertions.
...
.DESCRIPTION
Reads the optional depot site-code environment variable and normalizes its value.
...
.DESCRIPTION
Reads the optional depot site-code environment variable as a semicolon-separated
